...
const ownerNumber = ['32466304227']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("MUZAN-SIGMA~", '');
...
console.log("CONNECTING SIGMA-MD 🧬...");
...
console.log('SIGMA-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ SIGMA-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ MUZAN SIGMA ✅*
...
if(senderNumber.includes("32466304227")){
if(isReact) return
m.react("🦋")
   }
